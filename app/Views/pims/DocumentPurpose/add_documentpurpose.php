<?php
/**
 * Add documentpurposes
 */
?>
<div class="modal-dialog">
    <div class="modal-content">
        <form method="post" id="add_documentpurpose" onsubmit="return false">
            <?= csrf_field(); ?>
            <div class="modal-header">
                <h5 class="modal-title fs-5">Add DocumentPurpose</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="code" id="code" value="<?= set_value('code'); ?>">
            ...
            <div class="modal-footer">
                <button type="submit" onclick="insertDocumentPurpose()" class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i>&nbsp;Add</button>
