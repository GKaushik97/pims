    ...
    <div class="card-body">
        ...
        foreach($project_data as $project) {
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-3 p-1"><div class="bg-info-subtle text-end fs-6 p-2 text-info-emphasis"><?= displayNumber($project['contract_value'] / 10000000, 4) ?></div></div>
                        <div class="col-md-3 p-1"><div class="bg-primary-subtle text-end fs-6 p-2 text-primary-emphasis"><?= displayNumber($receivables / 10000000, 4) ?></div></div>
                        <div class="col-md-3 p-1"><div class="bg-success-subtle text-end fs-6 p-2 text-success-emphasis"><?= displayNumber($received / 10000000, 4) ?></div></div>
                        <div class="col-md-3 p-1"><div class="bg-danger-subtle text-end fs-6 p-2 text-danger-emphasis"><?= displayNumber(($balance) / 10000000,4) ?></div></div>
                    </div>
                </div>
            </div>
            <?
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-3 p-1"><div class="bg-info bg-opacity-25 bg-opacity-theme-5 text-end fs-5 p-2 text-info-emphasis"><?= displayNumber($total_contract / 10000000, 4) ?></div></div>
                    <div class="col-md-3 p-1"><div class="bg-primary bg-opacity-25 bg-opacity-theme-5 text-end fs-5 p-2 text-primary-emphasis"><?= displayNumber($total_receivables / 10000000, 4) ?></div></div>
                    <div class="col-md-3 p-1"><div class="bg-success bg-opacity-25 bg-opacity-theme-5 text-end fs-5 p-2 text-success-emphasis"><?= displayNumber($total_received / 10000000, 4) ?></div></div>
                    <div class="col-md-3 p-1"><div class="bg-danger bg-opacity-25 bg-opacity-theme-5 text-end fs-5 p-2 text-danger-emphasis"><?= displayNumber($total_balance / 10000000, 4) ?></div></div>
                </div>
            </div>
        </div>
    </div>
