        ...
        <div class="row">
            <div class="col-md-6">
                <div class="fw-semibold text-info-emphasis border border-info-subtle rounded-2 p-4">
                    <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($financial_totals['basic_value'] / 10000000), 4) ?></h5>
            ...
            <div class="col-md-6">
                <div class="fw-semibold text-success-emphasis border border-success-subtle rounded-2 p-4">
                    <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($financial_totals['invoice_value'] / 10000000), 4) ?></h5>
