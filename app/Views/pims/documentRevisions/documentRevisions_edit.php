 ...
 */
$id_val = isset($documentRevision['id']) ? $documentRevision['id'] : (isset($_POST['id']) ? $_POST['id'] : '');
$name_val = isset($documentRevision['name']) ? $documentRevision['name'] : set_value('name');
?>

<div class="modal-dialog">
	<div class="modal-content">
		<form method="post" id="edit_revision" onsubmit="return false">
			<?= csrf_field(); ?>
			<input type="hidden" name="id" value="<?= $id_val; ?>">
			<div class="modal-header">
				<h5 class="modal-title fs-5">Edit DocumentRevision</h5>
            ...
            <div class="modal-footer">
            	<button type="submit" onclick="updateDocumentRevision()" class="btn btn-success btn-sm"><i class="bi bi-check-square"></i>&nbsp;Update</button>
