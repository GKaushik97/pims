<div class="modal-dialog">
    <div class="modal-content">
        <form method="post" id="add_revision" onsubmit="return false">
            <?= csrf_field(); ?>
            ...
            <div class="modal-footer">
                <button type="submit" onclick="insertDocumentRevision()" class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i>&nbsp;Add</button>
