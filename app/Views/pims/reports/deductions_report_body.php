	...
	<table class="table table-bordered table-hover table-striped table-sm mb-0">
		<thead class="align-middle">
			<tr>
				...
				<th nowrap><? if($sortby == 'p.code') print $arrow; ?><a href="javascript:void(0)" onclick="deductionReportBody('<? echo $rows; ?>','<? print $pageno; ?>','p.code','<? echo $sort_order_alt; ?>')">Project</a></th>
		...
		<tbody class="align-middle">
			...
			if($invoice_deduction){
				...
				<tr>
					...
					<td nowrap><?= $inv_deduction['project_code'] ?></td>
			...
			<tr>
				<td colspan="8" class="bg bg-warning">No Records Found</td>
			</tr>
		<? } ?>
		</tbody>
	</table>
		...
		<div class="card-group">
			...
			<div class="card text-bg-success">
				<div class="card-body success">
					<h5 class="card-title text-end fs-5"><? echo displayNumber(($total_amt / 10000000), 4); ?></h5><p class="card-text">Total Deduction Amount (Cr.)</p>
				</div>
			</div>
		</div>
	</div>	
