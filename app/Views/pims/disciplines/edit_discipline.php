...
<div class="modal-dialog">
    <div class="modal-content">
        <form method="post" id="edit_discipline" onsubmit="return false">
            <?= csrf_field(); ?>
            <input type="hidden" name="id" value="<?= $id_val; ?>">
            <div class="modal-header">
                <h5 class="modal-title fs-5">Edit Discipline</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-2">
                    <label for="status" class="col-sm-3 col-form-label text-end">Discipline Status&nbsp;<span class="text-danger">*</span>&nbsp;:</label>
                    <div class="col-sm-7">
            ...
            <div class="modal-footer">
                <button type="submit" onclick="updateDiscipline()" class="btn btn-success btn-sm"><i class="bi bi-check-square"></i>&nbsp;Update</button>
