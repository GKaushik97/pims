...
<div class="card-group">
    <div class="card text-bg-info">
        <div class="card-body">
            <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($totals['basic_sum'] / 10000000), 4) ?></h5>
            <p class="card-text">Basic</p>
        </div>
    </div>
    <div class="card text-bg-warning">
        <div class="card-body">
            <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($total_invoice_value / 10000000), 4) ?></h5>
            <p class="card-text">
                Basic + TAX&nbsp;
                <a class="text-black" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-html="true" data-bs-content="SGST: <?= displayNumber(($totals['sgst_sum'] / 10000000), 4) ?>, CGST: <?= displayNumber(($totals['cgst_sum'] / 10000000), 4) ?>"><i class="bi bi-info-circle"></i></a>
            </p>
        </div>
    </div>
    <div class="card text-bg-secondary">
        <div class="card-body">
            <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($totals['other_deductions_sum'] / 10000000), 4) ?></h5>
            <p class="card-text">Other Deductions&nbsp;
                <a class="text-white" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-html="true" data-bs-content="TDS: <?= displayNumber(($totals['tds_sum'] / 10000000), 4) ?>, SGST-TDS: <?= displayNumber(($totals['tds_sgst_sum'] / 10000000), 4) ?>, CGS-TDS: <?= displayNumber(($totals['tds_cgst_sum'] / 10000000), 4) ?>, Labour Cess: <?= displayNumber(($totals['labour_cess_sum'] / 10000000), 4) ?>, Other Deductions: <?= displayNumber(($totals['other_deductions_sum'] / 10000000), 4) ?>"><i class="bi bi-info-circle"></i></a>
            </p>
        </div>
    </div>
    <div class="card text-bg-primary">
        <div class="card-body">
            <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($total_receivable / 10000000), 4) ?></h5>
            <p class="card-text">Receivables</p>
        </div>
    </div>
    <div class="card text-bg-success">
        <div class="card-body">
            <h5 class="card-title text-end fs-5">Cr. <?= displayNumber(($totals['received_sum'] / 10000000), 4) ?></h5>
            <p class="card-text">Received</p>
        </div>
    </div>
    <div class="card text-bg-danger">
        <div class="card-body">
            <h5 class="card-title text-end fs-5">Cr. <?= displayNumber((($total_receivable - $totals['received_sum']) / 10000000), 4) ?></h5>
